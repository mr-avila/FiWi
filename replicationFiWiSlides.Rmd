...
- and then display on the other side the same graph from GP(2010, p.35)

- also: here is a table with the our and GP estimates for comparisons - your bootstrapped standard errors are already included
...
### Explanations for divergences between replication and Gebel and Pfeiffer (2010)
