...
\item
  ...
  \item
    More ``less talented'' accepted to higher education and thereby
...
\item
  ...
  \(b_i\) are redundant. ``Staying longer in Education is determined by
  \(X\) covariates''.
\end{itemize}
...
\item
  also: here is a table with the our and GP estimates for comparisons -
...
and Pfeiffer (2010)}
\protect\hypertarget{explanations-for-divergences-between-replication-and-gebel-and-pfeiffer-2010}{}
