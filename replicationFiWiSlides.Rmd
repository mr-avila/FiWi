...
### Background Information {.allowframebreaks}
...
**Second stage**: augmented wage equation
...
- that both coefficients are (mostly) negative hints that educational expansion caused more âless ableâ to achieve higher education

### Divergences between replication and Gebel and Pfeiffer (2010)
