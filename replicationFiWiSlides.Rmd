...
```{bash eval=FALSE, echo=T,  size="small"}
...
![](./img/code_CMI01.png){height="300px"}


### codes 

TODO: Marcelo, please check if that screenshot of the code works - R doesnt want to compile again :/

![](./img/code_cf.png){height="300px"}

```{bash eval=FALSE, echo=T,  size="small"}
* First step: Estimate the reduced form of schooling, i.e. regress schooling 
...
* Second step:  Estimate the structural equation and include the residuals from 
* the reduced form as an additional regressor
qui: reg lnw school sex age age_sq rural edu_f edu_m ///
    occ_f v`n' c.v`n'#c.school if syear==`n' // exclude instrument
