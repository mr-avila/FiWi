...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{*}\NormalTok{ First stage: Estimate the reduced form of schooling, i.e. regress schooling }
...
\ExtensionTok{*}\NormalTok{ Second stage:  Estimate the structural equation and include the residuals from }
