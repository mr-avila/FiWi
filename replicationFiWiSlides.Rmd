...
-	More “less talented” accepted to higher education & thereby decreasing the average productivity levels of higher educated workers
...
(Comment) imo not super important, could be neglected because we have enough stuff tot alk about - but nice table!
...
--> Individuals with higher expected benefits from education are more likely to remain longer in education
...
- IV Methods
  - if education is correlated with **unobserved individual heterogeneity**, IV methods 
...
### Results and Comparison {.allowframebreaks}
...
![Replication results: Comparison between OLS, CMI and CF approaches](img/OLS_CMI_CF_RepliSC.png){height="250px"}
